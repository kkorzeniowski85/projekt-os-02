 ...
 *
 * Teksty biorą się wprost z plików treści (lib/akademia/curriculum), więc dopisanie
 * zdania w treści + `npm run audio:akademia` = nagranie na miejscu.
 *
 * Uruchomienie:
 *   npm run audio:akademia                 # tylko brakujące pliki
 *   npm run audio:akademia -- --force      # nadpisz wszystko
 *   npm run audio:akademia -- --voice en-GB-RyanNeural
 */
...
import { numbersWithAudio, numberToWords } from "../../lib/akademia/curriculum/numbers.ts";
import { audioSlug } from "../../lib/akademia/curriculum/slug.ts";
import { TABLES } from "../../lib/akademia/curriculum/tables.ts";
import { mathsPhrases } from "../../lib/akademia/curriculum/maths.ts";
import { readingPhrases } from "../../lib/akademia/curriculum/reading.ts";
import { classroomPhrases } from "../../lib/akademia/curriculum/classroom.ts";
import { countingPhrases } from "../../lib/akademia/tables/sessions.ts";
...
const dirs = {
  numbers: path.join(root, "public", "audio", "akademia", "numbers"),
  facts: path.join(root, "public", "audio", "akademia", "facts"),
  phrases: path.join(root, "public", "audio", "akademia", "phrases"),
};
