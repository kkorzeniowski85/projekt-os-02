...
import { playFact, stopVictoryFanfare, unlockAudio } from "@/lib/akademia/audio";
import { buildMtcForm, factKey, MTC, type Question } from "@/lib/akademia/curriculum/tables";
import { useProgress, type PendingAttempt, type SessionOutcome } from "@/lib/akademia/progress/store";
import type { FactState, SessionMode } from "@/lib/akademia/progress/types";
