...
import { Card, PageHeader, ParentTip, Speaker } from "@/components/akademia/ui";
import { UnitList } from "@/components/akademia/UnitList";
import { playText } from "@/lib/akademia/audio";
import { CLASSROOM_UNITS, LESSON_TALK, TEACHER_SAYS } from "@/lib/akademia/curriculum/classroom";
    ...
    <div className="flex flex-col gap-6">
      ...
      <ParentTip title="Dla rodzica">
        ...
        <p>
          ...
          understand”), ćwiczy dział Dźwięki (Słowa i zwroty) w temacie „Ratunek!”:{" "}
          <Link href="/slownictwo/" className="underline">
            otwórz Słowa i zwroty
          </Link>
          .
        </p>
      </ParentTip>
