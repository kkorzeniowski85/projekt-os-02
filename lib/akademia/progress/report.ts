...
import { parseFact } from "@/lib/akademia/curriculum/tables";
import { MATHS_TOPICS } from "@/lib/akademia/curriculum/maths";
import { READING_TEXTS, SKILL_LABEL, type ReadingSkill } from "@/lib/akademia/curriculum/reading";
import { CLASSROOM_UNITS } from "@/lib/akademia/curriculum/classroom";
import { MTC_WINDOW_START, daysUntil } from "@/lib/akademia/mtcDates";
import { pl } from "@/lib/akademia/pl";
import { FACT_RULES, focusTable, tablesSummary, weakestFacts } from "@/lib/akademia/tables/practice";
