 ...
 *  1. Nagranie z /public/audio/akademia (brytyjski głos neuronowy z generatora),
 ...
 *
 * Kategorie nagrań:
 *  - /audio/akademia/numbers/<n>.mp3 — liczby słownie po brytyjsku („one hundred and five"),
 *  - /audio/akademia/facts/<a>x<b>.mp3 — fakt tabliczki („seven times eight is fifty-six"),
 *  - /audio/akademia/phrases/<slug>.mp3 — zdania, pytania, polecenia (slug: lib/akademia/curriculum/slug.ts).
 */
...
// Nagrania Akademii mają własny katalog: kilka nazw w phrases/ powtarza się
// w Lidze (dział Dźwięki) z inną treścią nagrania.
const CLIP_BASE = `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/audio/akademia`;
