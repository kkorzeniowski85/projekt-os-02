...
export const LESSONS: Record<string, Lesson> = {
  ...
  th: {
    ...
    blend: [
      { word: "this", graphemes: ["th", "i", "s"], targetIndex: 0, pl: "to", emoji: "👇" },
      { word: "that", graphemes: ["th", "a", "t"], targetIndex: 0, pl: "tamto", emoji: "👉" },
  ...
  air: {
    ...
    choice: [
      ...
      { answer: "stairs", options: ["stairs", "stars", "stares"], pl: "schody", emoji: "⬆️" },
    ],
    redWords: ["the", "there"],
  },
  ...
  ea: {
    ...
    choice: [
      ...
      { answer: "sea", options: ["sea", "see", "say"], pl: "morze", emoji: "🌊" },
  ...
  "u-e": {
    ...
    blend: [
      ...
      { word: "June", graphemes: ["j", "u-e", "n"], targetIndex: 1, pl: "czerwiec", emoji: "📅" },
    ],
    choice: [
  ...
  are: {
    ...
    choice: [
      ...
      { answer: "hare", options: ["hare", "hair", "here"], pl: "zając", emoji: "🐇" },
  ...
  ur: {
    ...
    blend: [
      ...
      { word: "purse", graphemes: ["p", "ur", "s"], targetIndex: 1, pl: "portmonetka", emoji: "👛" },
    ],
    choice: [
  ...
  er: {
    ...
    choice: [
      ...
      { answer: "dinner", options: ["dinner", "diner", "winner"], pl: "kolacja", emoji: "🍽️" },
  ...
  ai: {
    ...
    choice: [
      { answer: "rain", options: ["rain", "ran", "rein"], pl: "deszcz", emoji: "🌧️" },
  ...
  ure: {
    ...
    chant: "ure — ure — ure!",
    parentIntro:
      'Ostatni dźwięk całego programu! „U-e” jak w „sure”. Uwaga: „sure” zaczyna się ' +
      'dźwiękiem „sz”, choć pisze się przez „s” — to wyjątek, powiedz to wprost.',
    listen: [
      ...
      { word: "sun", hasTarget: false, pl: "słońce", emoji: "☀️" },
      { word: "picture", hasTarget: true, pl: "obrazek", emoji: "🖼️" },
      { word: "pen", hasTarget: false, pl: "długopis", emoji: "🖊️" },
    ],
    blend: [
      { word: "pure", graphemes: ["p", "ure"], targetIndex: 1, pl: "czysty", emoji: "💧" },
      { word: "cure", graphemes: ["c", "ure"], targetIndex: 1, pl: "lekarstwo", emoji: "💊" },
      { word: "picture", graphemes: ["p", "i", "c", "t", "ure"], targetIndex: 4, pl: "obrazek", emoji: "🖼️" },
    ],
    choice: [
      { answer: "sure", options: ["sure", "shore", "sore"], pl: "pewny", emoji: "✔️" },
      { answer: "pure", options: ["pure", "poor", "pour"], pl: "czysty", emoji: "💧" },
