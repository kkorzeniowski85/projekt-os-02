 ...
 * ekranu (ServiceWorkerRegistrar). W trakcie sesji to by urwało pracę
 * dziecka (próby siedzą w pamięci do końca sesji), więc ekrany ćwiczeń
 * zgłaszają tu, że są w toku, a przeładowanie czeka, aż skończą.
 * Kopia szkola/lib/sessionBusy.ts — obie aplikacje zachowują się tak samo.
 */
